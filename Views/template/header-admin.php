...
<head>
    ...
    <title>Yo Reparo</title>
    <meta content="Admin Dashboard" name="description" />
    <meta content="ThemeDesign" name="author" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />

    <link rel="shortcut icon" href="<?php echo BASE_URL; ?>public/img/log2.webp">
        ...
        <div class="left side-menu">
            ...
            <div class="left-side-logo d-block d-lg-none">
                <div class="text-center">
                    <a href="index.html" class="logo"><img src="<?php echo BASE_URL; ?>public/img/log2.webp" height="20" alt="logo"></a>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-left	d-none d-lg-block">
                        <div class="text-center">
                            <a href="<?php echo BASE_URL; ?>" class="logo"><img src="<?php echo BASE_URL; ?>public/img/log2.webp" height="22" alt="logo"></a>
                        </div>
                    </div>
