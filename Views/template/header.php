...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL; ?>public/img/log2.webp" alt="" width="50"></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>public/img/log2.webp" alt="LOGO" width="50"></a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner-hero.avif">
                            <div class="hero__text">
                                <span>Ven y disfruta de nuestros productos</span>
                                <h2>Somos una tienda online <br />100% confiable</h2>
                                <p>Con mas de 10 años de experiencia en el mercado</p>
