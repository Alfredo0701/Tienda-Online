        ...
        <div class="row">
            <div class="categories__slider owl-carousel">
                <?php foreach ($data['categorias'] as $categoria) { ?>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo BASE_URL . 'public/img/categorias/descuento-Fin.webp' . $categoria['imagen']; ?>">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
                    <img src="<?php echo BASE_URL; ?>public/img/inf1.webp" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
